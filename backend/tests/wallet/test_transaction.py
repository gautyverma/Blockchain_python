...
from backend.config import MINIG_REWARD_INPUT, MINIG_REWARD


def test_transaction():
    sender_wallet = Wallet()
    recipient = ' recipiennt'
    amount = 50
...
def test_reward_transaction():
    ...
    assert transaction.input == MINIG_REWARD_INPUT
    assert transaction.output[miner_wallet.address] == MINIG_REWARD
